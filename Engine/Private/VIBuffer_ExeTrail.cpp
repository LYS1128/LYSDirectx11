#include "..\Public\VIBuffer_ExeTrail.h"

CVIBuffer_ExeTrail::CVIBuffer_ExeTrail(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CVIBuffer(pDevice, pDeviceContext)
{
}

CVIBuffer_ExeTrail::CVIBuffer_ExeTrail(const CVIBuffer_ExeTrail & rhs)
	: CVIBuffer(rhs)
{
}

HRESULT CVIBuffer_ExeTrail::NativeConstruct_Prototype()
{
...
HRESULT CVIBuffer_ExeTrail::NativeConstruct(void * pArg)
{
	return S_OK;
}

HRESULT CVIBuffer_ExeTrail::Update(_float4x4 * Mat)
{
...
CVIBuffer_ExeTrail * CVIBuffer_ExeTrail::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CVIBuffer_ExeTrail*	pInstance = new CVIBuffer_ExeTrail(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CVIBuffer_ExeTrail"));
...
CComponent * CVIBuffer_ExeTrail::Clone(void * pArg)
{
	CVIBuffer_ExeTrail*	pInstance = new CVIBuffer_ExeTrail(*this);
