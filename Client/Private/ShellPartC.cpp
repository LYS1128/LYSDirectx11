#include "stdafx.h"
#include "..\Public\ShellPartC.h"
#include "GameInstance.h"

CShellPartC::CShellPartC(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CShellPartC::CShellPartC(const CShellPartC & rhs)
	: CGameObject(rhs)
{
}

HRESULT CShellPartC::NativeConstruct_Prototype()
{
...
HRESULT CShellPartC::NativeConstruct(void * pArg)
{
...
void CShellPartC::Tick(_double TimeDelta)
{
...
void CShellPartC::LateTick(_double TimeDelta)
{
...
HRESULT CShellPartC::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_ShellPartC"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CShellPartC::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CShellPartC * CShellPartC::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CShellPartC*	pInstance = new CShellPartC(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CShellPartC"));
...
CGameObject * CShellPartC::Clone(void * pArg)
{
	CShellPartC*	pInstance = new CShellPartC(*this);
