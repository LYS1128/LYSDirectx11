#include "stdafx.h"
#include "..\Public\QueenBase.h"
#include "GameInstance.h"

CQueenBase::CQueenBase(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CQueenBase::CQueenBase(const CQueenBase & rhs)
	: CGameObject(rhs)
{
}

HRESULT CQueenBase::NativeConstruct_Prototype()
{
...
HRESULT CQueenBase::NativeConstruct(void * pArg)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(0.f, 0.06f, 130.82f, 1.f));
	m_pAABBCom->Set_Active(true);
	return S_OK;
}

void CQueenBase::Tick(_double TimeDelta)
{
...
void CQueenBase::LateTick(_double TimeDelta)
{
...
HRESULT CQueenBase::Render_LightDepth()
{
...
HRESULT CQueenBase::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_BOSS, TEXT("Prototype_Component_Model_QueenBase"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
	...
	ColliderDesc.vSize = _float3(3.f, 10.f, 3.f);
...
HRESULT CQueenBase::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CQueenBase * CQueenBase::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CQueenBase*	pInstance = new CQueenBase(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CQueenBase"));
...
CGameObject * CQueenBase::Clone(void * pArg)
{
	CQueenBase*	pInstance = new CQueenBase(*this);
