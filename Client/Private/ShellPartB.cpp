#include "stdafx.h"
#include "..\Public\ShellPartB.h"
#include "GameInstance.h"

CShellPartB::CShellPartB(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CShellPartB::CShellPartB(const CShellPartB & rhs)
	: CGameObject(rhs)
{
}

HRESULT CShellPartB::NativeConstruct_Prototype()
{
...
HRESULT CShellPartB::NativeConstruct(void * pArg)
{
...
void CShellPartB::Tick(_double TimeDelta)
{
...
void CShellPartB::LateTick(_double TimeDelta)
{
...
HRESULT CShellPartB::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_ShellPartB"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CShellPartB::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CShellPartB * CShellPartB::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CShellPartB*	pInstance = new CShellPartB(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CShellPartB"));
...
CGameObject * CShellPartB::Clone(void * pArg)
{
	CShellPartB*	pInstance = new CShellPartB(*this);
