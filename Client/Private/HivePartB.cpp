#include "stdafx.h"
#include "..\Public\HivePartB.h"
#include "GameInstance.h"

CHivePartB::CHivePartB(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CHivePartB::CHivePartB(const CHivePartB & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHivePartB::NativeConstruct_Prototype()
{
...
HRESULT CHivePartB::NativeConstruct(void * pArg)
{
...
void CHivePartB::Tick(_double TimeDelta)
{
...
void CHivePartB::LateTick(_double TimeDelta)
{
...
HRESULT CHivePartB::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_HivePartB"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CHivePartB::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CHivePartB * CHivePartB::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CHivePartB*	pInstance = new CHivePartB(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CHivePartB"));
...
CGameObject * CHivePartB::Clone(void * pArg)
{
	CHivePartB*	pInstance = new CHivePartB(*this);
