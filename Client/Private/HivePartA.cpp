#include "stdafx.h"
#include "..\Public\HivePartA.h"
#include "GameInstance.h"

CHivePartA::CHivePartA(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CHivePartA::CHivePartA(const CHivePartA & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHivePartA::NativeConstruct_Prototype()
{
...
HRESULT CHivePartA::NativeConstruct(void * pArg)
{
...
void CHivePartA::Tick(_double TimeDelta)
{
...
void CHivePartA::LateTick(_double TimeDelta)
{
...
HRESULT CHivePartA::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_HivePartA"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CHivePartA::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CHivePartA * CHivePartA::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CHivePartA*	pInstance = new CHivePartA(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CHivePartA"));
...
CGameObject * CHivePartA::Clone(void * pArg)
{
	CHivePartA*	pInstance = new CHivePartA(*this);
