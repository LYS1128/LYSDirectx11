#include "stdafx.h"
#include "..\Public\JumpFeather.h"
#include "GameInstance.h"

CJumpFeather::CJumpFeather(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CJumpFeather::CJumpFeather(const CJumpFeather & rhs)
	: CGameObject(rhs)
{
}

HRESULT CJumpFeather::NativeConstruct_Prototype()
{
...
HRESULT CJumpFeather::NativeConstruct(void * pArg)
{
...
void CJumpFeather::Tick(_double TimeDelta)
{
...
void CJumpFeather::LateTick(_double TimeDelta)
{
...
HRESULT CJumpFeather::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CJumpFeather::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CJumpFeather * CJumpFeather::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CJumpFeather*	pInstance = new CJumpFeather(pDeviceOut, pDeviceContextOut);
...
CGameObject * CJumpFeather::Clone(void * pArg)
{
	CJumpFeather*	pInstance = new CJumpFeather(*this);
