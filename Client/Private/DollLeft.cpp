#include "stdafx.h"
#include "..\Public\DollLeft.h"
#include "GameInstance.h"

CDollLeft::CDollLeft(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CDollLeft::CDollLeft(const CDollLeft & rhs)
	: CGameObject(rhs)
{
}

HRESULT CDollLeft::NativeConstruct_Prototype()
{
...
HRESULT CDollLeft::NativeConstruct(void * pArg)
{
...
void CDollLeft::Tick(_double TimeDelta)
{
...
void CDollLeft::LateTick(_double TimeDelta)
{
...
HRESULT CDollLeft::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_BOSS, TEXT("Prototype_Component_Model_DollLeft"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CDollLeft::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CDollLeft * CDollLeft::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CDollLeft*	pInstance = new CDollLeft(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CDollLeft"));
...
CGameObject * CDollLeft::Clone(void * pArg)
{
	CDollLeft*	pInstance = new CDollLeft(*this);
