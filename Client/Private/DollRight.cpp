#include "stdafx.h"
#include "..\Public\DollRight.h"
#include "GameInstance.h"

CDollRight::CDollRight(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CDollRight::CDollRight(const CDollRight & rhs)
	: CGameObject(rhs)
{
}

HRESULT CDollRight::NativeConstruct_Prototype()
{
...
HRESULT CDollRight::NativeConstruct(void * pArg)
{
...
void CDollRight::Tick(_double TimeDelta)
{
...
void CDollRight::LateTick(_double TimeDelta)
{
...
HRESULT CDollRight::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_BOSS, TEXT("Prototype_Component_Model_DollRight"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CDollRight::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CDollRight * CDollRight::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CDollRight*	pInstance = new CDollRight(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CDollRight"));
...
CGameObject * CDollRight::Clone(void * pArg)
{
	CDollRight*	pInstance = new CDollRight(*this);
