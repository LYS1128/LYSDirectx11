#include "stdafx.h"
#include "..\Public\ShellPartA.h"
#include "GameInstance.h"

CShellPartA::CShellPartA(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CShellPartA::CShellPartA(const CShellPartA & rhs)
	: CGameObject(rhs)
{
}

HRESULT CShellPartA::NativeConstruct_Prototype()
{
...
HRESULT CShellPartA::NativeConstruct(void * pArg)
{
...
void CShellPartA::Tick(_double TimeDelta)
{
...
void CShellPartA::LateTick(_double TimeDelta)
{
...
HRESULT CShellPartA::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_ShellPartA"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CShellPartA::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CShellPartA * CShellPartA::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CShellPartA*	pInstance = new CShellPartA(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CShellPartA"));
...
CGameObject * CShellPartA::Clone(void * pArg)
{
	CShellPartA*	pInstance = new CShellPartA(*this);
