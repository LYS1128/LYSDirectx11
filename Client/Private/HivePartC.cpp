#include "stdafx.h"
#include "..\Public\HivePartC.h"
#include "GameInstance.h"

CHivePartC::CHivePartC(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CHivePartC::CHivePartC(const CHivePartC & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHivePartC::NativeConstruct_Prototype()
{
...
HRESULT CHivePartC::NativeConstruct(void * pArg)
{
...
void CHivePartC::Tick(_double TimeDelta)
{
...
void CHivePartC::LateTick(_double TimeDelta)
{
...
HRESULT CHivePartC::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_HivePartC"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CHivePartC::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CHivePartC * CHivePartC::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CHivePartC*	pInstance = new CHivePartC(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CHivePartC"));
...
CGameObject * CHivePartC::Clone(void * pArg)
{
	CHivePartC*	pInstance = new CHivePartC(*this);
